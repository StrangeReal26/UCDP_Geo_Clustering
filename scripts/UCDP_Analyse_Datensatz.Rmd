...
Georeferenzierte Daten zu Konfliktereignissen weltweit seit 1989
...
## Abrufen nur der Spaltennamen (Namen der Variablen)

**Info**

Eine Ausführliche Beschreibung der einezelnen Variablen ist im Codebook (UCDP Georeferenced Event Dataset Codebook Version 25.1) hinterlegt.

Link: https://ucdp.uu.se/downloads/replication_data/2025_ucdp-ged-251.pdf
...
# Anzahl Tote der zehn tödlichsten Konflikte
UCDPsmall |>
...
# Übersicht über die Anzahl Toten des Ukrainekriegs
...
# Anzahl Konflikte im Datensatz insgesamt

UCDPsmall |>
  summarise(
    n_conflicts_global = n_distinct(conflict_new_id)
  )

```

## Zeitliche Verteilung der Konfliktereignisse (1989 bis 2024)
...
# Sortiert nach Anzahl von Konfliktereignissen
...
Verwendung von Library "ggplot2" zur besseren Ausgestaltung der Diagramme
...
# Histogramm mit einem Balken pro Jahr
...
## Vergleich von zwei Variablen. Hier: Zivile und nicht zivile Opfer insgesamt
...
# Die Häufigsten Konflikte nach Anzahl sortiert

UCDPsmall |>
  count(conflict_name, sort = TRUE) |> 
  slice_head(n = 30)
...
## Vergleich der Toten aufgeschlüsselt nach Monat über kompletten Zeitraum
